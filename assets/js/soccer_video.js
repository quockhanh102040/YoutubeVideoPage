...
function renderVideos() {
    const listVideos = [
        ...
        {
            linkVideo: './list-videos/top_5_ban_thang.html',
            avatar: '../img/top_5_ban_thang_vong_9.jpg',
            time: '6:09',
            channelAvatar: '../img/k+_plus.jpg',
            title: 'TOP 5 BÀN THẮNG ĐẸP VÒNG 9 NGOẠI HẠNG ANH | SIÊU PHẨM MASON MOUNT, MÃN NHÃN CALLUM WILSON |EPL 21/22',
            author: 'Kplus Sports',
            view: '30 N lượt xem',
            date: '1 tháng trước'
        },
